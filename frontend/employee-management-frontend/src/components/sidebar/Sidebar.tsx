...
const navItems: NavItem[] = [
  ...
  icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none"><path d="M6 5H18M6 9H18M6 5C8 5 10 5 12 5C14.5 5 16 6.5 16 9C16 11.5 14.5 13 12 13H6L16 19" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  ,
},
  {
      ...
      <div className={styles.sidebarFooter}>
        <div className={styles.userRow}>
          ...
          <div className={styles.userInfo}>
            <span className={styles.userName}>Mihir Mistry</span>
